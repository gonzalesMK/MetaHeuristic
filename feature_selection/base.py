...
#            return np.asarray(predict_)
    ...
    @staticmethod
    def _score_func_to_gridsearch(estimator, X_test, y_test):
        ...
        return sum([sum([i].wvalues) for i in estimator.fitnesses_]) / len(estimator.fitnesses_)
